...
export type AdminInboxRuleListResponse = operations['admin___inbox-rule___list']['responses']['200']['content']['application/json'];
export type AdminInboxRuleSetRequest = operations['admin___inbox-rule___set']['requestBody']['content']['application/json'];
export type AdminInboxRuleSetResponse = operations['admin___inbox-rule___set']['responses']['200']['content']['application/json'];
export type AdminInboxRuleEditRequest = operations['admin___inbox-rule___edit']['requestBody']['content']['application/json'];
export type AdminInboxRuleEditResponse = operations['admin___inbox-rule___edit']['responses']['200']['content']['application/json'];
export type AdminInboxRuleDeleteRequest = operations['admin___inbox-rule___delete']['requestBody']['content']['application/json'];
export type AdminInboxRuleDeleteResponse = operations['admin___inbox-rule___delete']['responses']['200']['content']['application/json'];
